...
def calcular_precio_actualizado(precioAnt, porcentaje):
    aumento = (precioAnt*porcentaje)/100
    precioActual = precioAnt+aumento
    return precioActual
...
def actualizar_precios(lista,aumento):
    for i in lista:
        precio = calcular_precio_actualizado(i['precio'],aumento)
        i['precio'] = precio
